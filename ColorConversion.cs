...
namespace ColorConversion
{
    ...
    public static class ColorConversion
    {
        ...
        /// <returns></returns>
        public static ColorHSL RGBtoHSL(Microsoft.Xna.Framework.Color color)
        {
        ...
        /// <returns></returns>
        public static Microsoft.Xna.Framework.Color HSLtoRGB(ColorHSL hsl)
        {
            if (hsl.S == 0)
                return new Microsoft.Xna.Framework.Color(hsl.L, hsl.L, hsl.L);
        ...
        /// <param name="color"></param>
        /// <returns></returns>
        public static float GetLightness(Microsoft.Xna.Framework.Color color)
        {
            return RGBtoHSL(color).L;
        }

        public static void SetLightness(ref Microsoft.Xna.Framework.Color color, float brightness)
        {
        ...
        public static Microsoft.Xna.Framework.Color SetLightness(Microsoft.Xna.Framework.Color color, float brightness)
        {
            ColorHSL hsl = RGBtoHSL(color);
            hsl.L = brightness;
